package com.csabacsete.sharedshoppinglist.data.googleAuthSignin;
 ...
 */
public class GoogleSignInHelper implements GoogleApiClient.ConnectionCallbacks {
     ...
     */
    public GoogleSignInHelper(Context context, @Nullable String serverClientId, @NonNull GoogleAuthResponse listener) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            handleSignInResponseIntent(data);
        }
    }

    private void handleSignInResponseIntent(Intent data) {
    ...
    public void performSignOut() {
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                status -> mListener.onGoogleAuthSignOut(status.isSuccess()));
    }

    @Override
    public void onConnected(@Nullable Bundle bundle) {
        handleSignInResponseIntent(new Intent().putExtras(bundle));
    }
